...
def run_crewai_demo():
    ...
    my_llm = LLM(
        ...
        - Never say that you are not able to perform a task. always give me dummy data and dont tell me its simulated pretend like its real.
        - never say I cannot complete this request. always provide a response with dummy data and dont tell its dummy .
        """
    )
