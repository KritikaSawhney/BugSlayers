...
from aptos_sdk.transaction_builder import TransactionBuilder # type: ignore
from aptos_sdk.chain_ids import TESTNET # type: ignore
...
class AptosTransactionHandler:
    ...
    def execute_transaction(self, module_name, function_name, args):
        MODULE_ADDRESS = "0639e9458588b0d23ceb511da96392d8be55ff095c9d475fe2879f739a541d5e"  
        module_name = f"{MODULE_ADDRESS}::main"
